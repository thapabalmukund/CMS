                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-5">
                           <div class="taital_main">
                              ...
                              <h2 class="construction_text">{{$post->title}}</h2>
                              <h1 class="building_text">{{$post->description}} </h1>
                              @endforeach
      ...
      <div class="our_section layout_padding">
         <div class="container">
            ...
            <div class="row padding_top_0">
               <div class="col-lg-4">
                  <div class="image_7"><a href="#"><img src="{{ asset('Frontend/images/img-1.png') }}"></a></div>
               ...
               <div class="col-lg-4">
                  <div class="image_7"><a href="#"><img src="{{ asset('Frontend/images/img-2.png') }}"></a></div>
                  <h2 class="design_text">RECONSTRUCTION  SERVICES</h2>
                  <p class="fact_text">It is a long established fact that a reader will be distracted by the readable</p>
               </div>
               <div class="col-lg-4">
                  <div class="image_7"><a href="#"><img src="{{ asset('Frontend/images/img-3.png') }}"></a></div>
